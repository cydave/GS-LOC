...
_REQUEST_REQUESTWIFI = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="mac",
            full_name="Request.RequestWifi.mac",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
Request = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    dict(
        RequestWifi=_reflection.GeneratedProtocolMessageType(
            "RequestWifi",
            (_message.Message,),
            dict(
